...
/**
 * 自定义异常(所有业务异常 程序异常编码是小于0 业务异常编码是大于0 不适用等于0的编码)
 * @author zengxueqi
 * @program july-excel
 * @since 2020-05-09 11:36
 **/
public class BnException extends RuntimeException {
     ...
     * 返回异常编码
     * @param
     * @return java.lang.Integer 返回异常编码
     * @author zengxueqi
     * @since 2020/5/9
     */
    public Integer code() {
     ...
     * @param
     * @return java.lang.String 返回异常消息
     * @author zengxueqi
     * @since 2020/5/9
     */
     ...
     * 输出异常的堆栈的关键信息
     * @param ex 异常类型
     * @return java.lang.String 异常类型的字符串
     * @author zengxueqi
     * @since 2020/5/9
     */
    ...
    /**
     * 使用给的参数生成业务异常(占位符必须是{0},{1},{2}等等,如果写成{}的话会出错。)
     * @param code    异常编码
     * @param message 异常消息,带有占位符的消息
     * @param args    异常消息占位参数, 依次对应消息中的{0},{1},{2}等等
     * @return com.july.excel.exception.BnException
     * @author zengxueqi
     * @since 2020/5/9
     */
     ...
     * 转换指定的异常
     * @param cause 异常类
     * @return com.july.excel.exception.BnException 返回标准异常
     * @author zengxueqi
     * @since 2020/5/9
     */
    ...
    /**
     * 使用给的参数生成业务异常 消息使用默认消息、无占位参数(使用默认消息，但默认消息中无占位符,故这里不需要传递参数)
     * @param code 异常编码,必须是存在errors.properties中的编码
     * @param args 占位参数,依次对应消息中的{0},{1},{2}等等
     * @return com.july.excel.exception.BnException 异常对象
     * @author zengxueqi
     * @since 2020/5/9
     */
     ...
     * @param message 异常消息，可包含占位符{0},{1},{2}等
